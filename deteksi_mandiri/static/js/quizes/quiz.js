		...
		$.ajax({
			...
			success: function(response){
				...
				if(response.full == "True" || truth){
					...
					document.getElementById("score-to-pass").classList.remove("disp_none")
					scoreBox.innerHTML = `${response.passed=="True" ? 'Congratulations, no symptoms associated with COVID-19' : 'The symptoms you experience are very similar to the signs of the COVID-19 virus infection. Immediately contact the relevant parties to do a swab test!'}. Your score is ${response.score}`
